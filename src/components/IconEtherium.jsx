...
export const IconEtherium = props => {
	const {
		color = [['#386AFF', '#2652FF'], ['#2B59FF', '#619BFF']],
		height = 26,
		width = 26
	} = props;
			...
			>
				<g id="Group" transform="translate(5.200000, -0.000000)">
					<polygon
						...
						opacity="0.5"
						points="0 12.5885087 7.29627095 17.4020237 14.908923 12.5677507 7.29840534 0"
					/>
					<polygon
						id="Path-22"
						fill="url(#linearGradient-2)"
						points="0 14.2415502 7.47530612 25.2014603 14.9705678 14.2415502 7.47530612 19.1492356"
					/>
				</g>
			</g>
		</svg>
